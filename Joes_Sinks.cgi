...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/silver-mage.jpg" alt="" /></a>Joe's Sinks</h1>"
...
echo "These sinks were donated by Joe.  I don't know where this guy is from but apparently there they have Horny Toad sinks.  Everybody try to push Horny Toad sinks when"
echo "when dealing with customers.  We need to do more Horny Toad sink cutouts.  If you find any of these drawings useful, especially any Horny Toad sink drawings, then why not email me your sinks too?  Let's all be part of the problem"
...
for D in `find ./sinks/donations/JOES_SINKS/* -maxdepth 0 -type d`; do
#for D in ./sinks/donations/AI/*; do

    len=`echo $D|wc -c`
    #len=$((len-5))
	j=$(echo $D | cut -c30-$len)
	printf "<img class="lightning" src="mainimages/red-mage.jpg" alt="" > </img>"
