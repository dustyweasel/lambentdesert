...
echo "<h1><a href="SMG.cgi"><img class="wesnoth" src="mainimages/bone-shooter.jpg" alt="" /></a>SMG DXF'S AND AlphaCAM drawings!</h1>"
...
echo "</p><p class="big"><a href="SMG.cgi">SMG SINKS</a></p>"
