...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/rouser.jpg" alt="" /></a>RJ's SINKS</h1>"
...
echo "These sinks were donated by RJ.  They're all Blancos.  At RJ's shop they refuse to cut anything but Blanco sinks. If you ask for a Kohler sink at RJ's shop they refund your money and refuse to do business with you."
echo "If you ask for an Elkay they'll shoot you.  If you find them useful why not email me your sinks too?  Even if they're not Blancos.  Let's all be part of the problem"
echo "together!: <a href="expand.html">MASTER PLAN</a>"
#echo "<br/><br/>Per the donator:<br/>"
#echo "<br/><br/>&quotAlso just an fyi all my sinks I have will have a 1/4&quot neg reveal. Unless specified and some of the templates may have cnc tooling that you will have to delete&quot -Estrada"
...
for D in `find ./sinks/donations/RJ/* -maxdepth 0 -type d`; do
#for D in ./sinks/donations/AI/*; do

    len=`echo $D|wc -c`
    #len=$((len-5))
	j=$(echo $D | cut -c22-$len)
	printf "<img class="lightning" src="mainimages/impaler.jpg" alt="" > </img>"
