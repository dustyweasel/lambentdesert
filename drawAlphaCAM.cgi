...
then
  QUERY_STRING="sinks/error/error"
fi
...
echo "<h1><a href="sinks.cgi"><img class="wesnoth" src="mainimages/oracle-se-magic2.jpg" alt="" /></a>View!</h1>"

echo "<p>"
echo "If you're dying to see a picture of this AlphaCAM drawing then... too bad.  I don't know how to display one."
...
echo "</p>"
#echo "<h2>HEY YOU!  YEAH, YOU!  The one downloading sinks for free!</h2>"
#echo "<p>Donate sinks to lambentdesert.com!  Click here to learn more!: <a href="expand.html">Master Plan</a></p>"

echo "<p class="big">Download this AlphaCAM drawing at your own risk:<br/><a href=$QUERY_STRING>$j</a> &#11013;This is not a DXF!<br/><br/>"

echo "Check dimensions on your phone with... I don't know.  If you have any ideas email me: <a href="mailto:laconiclizard@lambentdesert.com">laconiclizard@lambentdesert.com</a>"
