...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/peasant.jpg" alt="" /></a>Terrel SINKS</h1>"
...
echo "These sinks were donated by Terrel.  If you find them useful why not email me your sinks too?  Let's all be part of the problem"
...
for D in `find ./sinks/donations/Terrel/* -maxdepth 0 -type d`; do
#for D in ./sinks/donations/AI/*; do

    len=`echo $D|wc -c`
    #len=$((len-5))
	j=$(echo $D | cut -c26-$len)
	printf "<img class="lightning" src="mainimages/peasant2.jpg" alt="" > </img>"
    
	h="Terreldxflist.cgi?"$j
