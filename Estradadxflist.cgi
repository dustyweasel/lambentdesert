...
echo "<h1><a href="Estrada.cgi"><img class="wesnoth" src="mainimages/troll2.jpg" alt="" /></a>Estrada AlphaCAM drawings!</h1>"
...
then
	...
	find ./sinks/donations/Estrada/$QUERY_STRING -type f -iname "*.ard" | xargs -n 1 echo > $TempFile2
	#harvester=$TempFile
...
echo "</p><p class="big"><a href="Estrada.cgi">Estrada SINKS</a></p>"
