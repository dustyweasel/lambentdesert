...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/draug-bob8.jpg" alt="" /></a>SMG SINKS</h1>"
...
for D in `find ./sinks/donations/SMG/* -maxdepth 0 -type d`; do
#for D in ./sinks/donations/AI/*; do

    len=`echo $D|wc -c`
    #len=$((len-5))
	j=$(echo $D | cut -c23-$len)
	printf "<img class="lightning" src="mainimages/bone-shooter.jpg" alt="" > </img>"
