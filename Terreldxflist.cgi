...
echo "<h1><a href="Terrel.cgi"><img class="wesnoth" src="mainimages/peasant2.jpg" alt="" /></a>Terrel DXF'S!</h1>"
...
then
	...
	find ./sinks/donations/Terrel/$QUERY_STRING -type f -iname "*.dxf" | xargs -n 1 echo > $TempFile
...
echo "</p><p class="big"><a href="Terrel.cgi">Terrel SINKS</a></p>"
