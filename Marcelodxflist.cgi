...
echo "<h1><a href="Marcelo.cgi"><img class="wesnoth" src="mainimages/siren.jpg" alt="" /></a>Marcelo DXF'S and DWG'S!</h1>"
...
then
	...
	find ./sinks/donations/Marcelo/$QUERY_STRING -type f -iname "*.dxf" | xargs -n 1 echo > $TempFile
	find ./sinks/donations/Marcelo/$QUERY_STRING -type f -iname "*.dwg" | xargs -n 1 echo > $TempFile2
	harvester=$TempFile
...
echo "</p>"
echo "</p><p class="big"><a href="Marcelo.cgi">Marcello Sinks</a></p>"
