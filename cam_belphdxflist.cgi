...
echo "<h1><a href="cam_belph.cgi"><img class="wesnoth" src="mainimages/guard-attack-1.png" alt="" /></a>cam_belph AlphaCAM drawings!</h1>"
...
then
	...
	find ./sinks/donations/cam_belph/$QUERY_STRING -type f -iname "*.asd" | xargs -n 1 echo > $TempFile2
	#harvester=$TempFile
...
echo "</p><p class="big"><a href="cam_belph.cgi">cam_belph SINKS</a></p>"
