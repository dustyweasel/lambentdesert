...
echo "<h1><a href="Gricks.cgi"><img class="wesnoth" src="mainimages/fairy2.jpg" alt="" /></a>Gricks' AlphaCAM drawings!</h1>"
...
then
	...
	find ./sinks/donations/Gricks/$QUERY_STRING -type f -iname "*.ard" | xargs -n 1 echo > $TempFile
...
echo "</p><p class="big"><a href="Gricks.cgi">Gricks' Sinks</a></p>"
