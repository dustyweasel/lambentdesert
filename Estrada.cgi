...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/troll.jpg" alt="" /></a>Estrada SINKS</h1>"
...
echo "These sinks were donated by Estrada.  More to come, hopefully.  If you find them useful why not email me your sinks too?  Let's all be part of the problem"
...
for D in `find ./sinks/donations/Estrada/* -maxdepth 0 -type d`; do
#for D in ./sinks/donations/AI/*; do

    len=`echo $D|wc -c`
    #len=$((len-5))
	j=$(echo $D | cut -c27-$len)
	printf "<img class="lightning" src="mainimages/troll2.jpg" alt="" > </img>"
    
	h="Estradadxflist.cgi?"$j
