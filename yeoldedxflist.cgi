...
echo "<h1><a href="ye_olde_stash.cgi"><img class="wesnoth" src="mainimages/ancient-lich-magic-3.png" alt="" /></a>Ye Olde DXF's and DWG's</h1>"
...
then
    ...
    echo "One more donation and I make all these downloadable.<br/><br/>"
    echo "</mark>"
	echo "$QUERY_STRING:<br/>"

	find ./sinks/ruff/$QUERY_STRING -type f -iname "*.dxf" | xargs -n 1 echo > $TempFile
	find ./sinks/ruff/$QUERY_STRING -type f -iname "*.dwg" | xargs -n 1 echo > $TempFile2
...
echo "</p><p class="big"><a href="ye_olde_stash.cgi">Ye Olde Stash of DXF's and DWG's</a></p>"
