...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/jawal.jpg" alt="" /></a>A.I. SINKS</h1>"
...
echo "These sinks were donated by A.I.  If you find them useful why not email me your sinks too?  Let's all be part of the problem"
echo "together!: <a href="expand.html">MASTER PLAN</a>"
echo "<br/><br/>A.I. says:<br/>"
echo "-95% of these cutouts will be OH/Neg Reveal, however overhangs will vary<br/>"
echo "-Some were done by me. Some of these will include all three cutout types, labeled as such. All OH's will be 1/4&quot. Those should be good<br/>"
echo "-Some were done by a POS former coworker. These should all work, will all be OH, and will all vary depending on his mood for the day when he drew them."
...
#for D in ./sinks/donations/AI/*; do
	...
	printf "<img class="lightning" src="mainimages/batal.jpg" alt="" > </img>"
