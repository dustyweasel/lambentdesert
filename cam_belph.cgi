...
echo "<h1><a href="moresinks.cgi"><img class="wesnoth" src="mainimages/fighter.png" alt="" /></a>cam_belph SINKS</h1>"
...
echo "These sinks were donated by cam_belph.  If you find them useful why not email me your sinks too?  Let's all be part of the problem"
...
for D in `find ./sinks/donations/cam_belph/* -maxdepth 0 -type d`; do
#for D in ./sinks/donations/AI/*; do

    len=`echo $D|wc -c`
    #len=$((len-5))
	j=$(echo $D | cut -c29-$len)
	printf "<img class="lightning" src="mainimages/guard-attack-1.png" alt="" > </img>"
    
	h="cam_belphdxflist.cgi?"$j
